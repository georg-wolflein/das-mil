"""from https://github.com/jinxixiang/low_rank_wsi/blob/main/mil/models/ilra.py"""
...
class ILRA(nn.Module):
    def __init__(self, num_layers=2, feat_dim=768, hidden_feat=256, num_heads=8, topk=1, ln=False):
        super().__init__()
        ...
        # classifier
        self.classifier = nn.Linear(in_features=hidden_feat, out_features=1)
...
if __name__ == "__main__":
    model = ILRA(feat_dim=1024, hidden_feat=256, num_heads=8, topk=1)
